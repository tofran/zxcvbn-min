...
(function() {
  var feedback_tmpl, guess_times_tmpl, props_tmpl, render_results, results_tmpl, round_logs, round_to_x_digits, test_passwords;
...
{{/sequence}}
  ...
  render_results = function() {
    var i, len, password, query, r, ref, rendered, results, results_lst, user_inputs;
    query = $('#query').val();
